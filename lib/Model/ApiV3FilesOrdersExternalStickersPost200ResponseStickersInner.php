...
/**
 * ApiV3FilesOrdersExternalStickersPost200ResponseStickersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3FilesOrdersExternalStickersPost200ResponseStickersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v3_files_orders_external_stickers_post_200_response_stickers_inner';
    ...
    */
     ...
     * Sets order_id
     *
     * @param int|null $order_id Идентификатор сборочного задания
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Ссылка, по которой можно получить этикетку для сборочного задания
     *
     * @return self
     */
