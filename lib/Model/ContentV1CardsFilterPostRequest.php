...
/**
 * ContentV1CardsFilterPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsFilterPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_filter_post_request';
    ...
    */
     ...
     * Sets vendor_codes
     *
     * @param string[]|null $vendor_codes Массив  артикулов продавца. <br>Максимальное количество в запросе `100`.
     *
     * @return self
     */
