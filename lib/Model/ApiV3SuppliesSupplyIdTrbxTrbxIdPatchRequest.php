...
/**
 * ApiV3SuppliesSupplyIdTrbxTrbxIdPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxTrbxIdPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx__trbxId__patch_request';
    ...
    */
     ...
     * Sets order_ids
     *
     * @param int[] $order_ids Список заказов, которые необходимо добавить в короб.
     *
     * @return self
     */
