...
/**
 * ApiV1FeedbacksPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FeedbacksPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_feedbacks_patch_request';
    ...
    */
     ...
     * Sets was_viewed
     *
     * @param bool $was_viewed Просмотрен (`true`) или не просмотрен (`false`)
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text Текст ответа (max. 999 символов)
     *
     * @return self
     */
