...
class ApiV1FeedbackGet200ResponseDataVideo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('thumbnail_uri', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets uri
     *
     * @param string|null $uri Адрес видео
     *
     * @return self
     */
    ...
    {
        return $this->container['thumbnail_uri'];
    }

    /**
     * Sets thumbnail_uri
     *
     * @param string|null $thumbnail_uri Адрес изображений
     *
     * @return self
     */
    public function setThumbnailUri($thumbnail_uri)
    {
        if (is_null($thumbnail_uri)) {
            throw new \InvalidArgumentException('non-nullable thumbnail_uri cannot be null');
        }
        $this->container['thumbnail_uri'] = $thumbnail_uri;
