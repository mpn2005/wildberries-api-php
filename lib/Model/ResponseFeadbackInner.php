...
/**
 * ResponseFeadbackInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseFeadbackInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'responseFeadback_inner';
    ...
    protected static $openAPITypes = [
        ...
        'state' => 'string',
        'answer' => '\OpenAPI\Client\Model\ResponseFeadbackInnerAnswer',
    ...
    */
     ...
     * Sets matching_size
     *
     * @param string|null $matching_size <dl> <dt>   Соответствие заявленного размера реальному.   <br>Возможные значения: </dt> <dd>\"\" - для безразмерных товаров,</dd> <dd>\"ок\" - соответствует размеру,</dd> <dd>\"smaller\" - маломерит,</dd> <dd>\"bigger\" - большемерит</dd>               </dl>
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state <dt>Статус вопроса:</dt> <dd>`none` - не обработан (новый)</dd> <dd>`wbRu` - обработан</dd> <dd>`deleted` - удален</dd>
     *
     * @return self
     */
     ...
     * Gets answer
     *
     * @return \OpenAPI\Client\Model\ResponseFeadbackInnerAnswer|null
     */
     ...
     * Sets answer
     *
     * @param \OpenAPI\Client\Model\ResponseFeadbackInnerAnswer|null $answer answer
     *
     * @return self
     */
    ...
    public function setPhotoLinks($photo_links)
    {
        if (is_null($photo_links)) {
            throw new \InvalidArgumentException('non-nullable photo_links cannot be null');
        }
