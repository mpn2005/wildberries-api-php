...
/**
 * ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v2_cards_upload_post_request_inner_variants_inner_characteristics_inner';
    ...
    */
     ...
     * Sets value
     *
     * @param mixed $value Значение характеристики. Тип значения зависит от типа характеристики
     *
     * @return self
     */
