...
/**
 * NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriodConversions Class Doc Comment
 *
 * @category Class
 ...
 */
class NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriodConversions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedResponse_data_groups_inner_statistics_previousPeriod_conversions';
    ...
    protected static $openAPIFormats = [
        'add_to_cart_percent' => null,
        'cart_to_order_percent' => null,
        'buyouts_percent' => null
    ];
    ...
    protected static $setters = [
        ...
        'buyouts_percent' => 'setBuyoutsPercent'
    ];
    ...
    protected static $getters = [
        ...
        'buyouts_percent' => 'getBuyoutsPercent'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('buyouts_percent', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param float|null $add_to_cart_percent Конверсия в корзину, % (Какой процент посетителей, открывших карточку товара, добавили товар в корзину)
     *
     * @return self
     */
     ...
     *
     * @param float|null $cart_to_order_percent Конверсия в заказ, % (Какой процент поситителей, добавивших товар в корзину, сделали заказ)
     *
     * @return self
     */
    ...
    /**
     * Gets buyouts_percent
     *
     * @return float|null
     */
    public function getBuyoutsPercent()
    {
        return $this->container['buyouts_percent'];
    }

    /**
     * Sets buyouts_percent
     *
     * @param float|null $buyouts_percent Процент выкупа, % ( Какой процент посетителей, заказвших товар, его выкупили. Без учета товаров, которые еще доставляются покупателю.)
     *
     * @return self
     */
    public function setBuyoutsPercent($buyouts_percent)
    {
        if (is_null($buyouts_percent)) {
            throw new \InvalidArgumentException('non-nullable buyouts_percent cannot be null');
        }
        $this->container['buyouts_percent'] = $buyouts_percent;
