<?php
/**
 * AdvV1FullstatGet200ResponseDaysInnerAppsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvV1FullstatGet200ResponseDaysInnerAppsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1FullstatGet200ResponseDaysInnerAppsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_fullstat_get_200_response_days_inner_apps_inner';
    ...
    protected static $openAPITypes = [
        'app_type' => 'int',
        'nm' => '\OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInnerNmInner[]',
        'views' => 'int',
        'clicks' => 'int',
        'frq' => 'int',
        'unique_users' => 'int',
    ...
    */
     ...
     * Gets nm
     *
     * @return \OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInnerNmInner[]|null
     */
     ...
     * Sets nm
     *
     * @param \OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInnerNmInner[]|null $nm Блок статистики по артикулам WB
     *
     * @return self
     */
     ...
     * Sets views
     *
     * @param int|null $views Количество просмотров<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int|null $clicks Количество кликов.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets frq
     *
     * @param int|null $frq Частота (отношение количества просмотров к количеству уникальных пользователей)<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets unique_users
     *
     * @param int|null $unique_users Количество уникальных пользователей просмотревших товар.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets ctr
     *
     * @param float|null $ctr Показатель кликабельности.<br> Отношение числа кликов к количеству показов. Выражается в процентах.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc Средняя стоимость клика, ₽.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float|null $sum Затраты, ₽.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets atbs
     *
     * @param int|null $atbs Количество добавлений товаров в корзину.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets orders
     *
     * @param int|null $orders Количество заказов товара.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets cr
     *
     * @param int|null $cr CR(conversion rate) — это отношение количества заказов к общему количеству посещений кампании.<br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets shks
     *
     * @param int|null $shks Заказано товаров, шт <br> <b>В целом по платформе.</b>
     *
     * @return self
     */
     ...
     * Sets sum_price
     *
     * @param int|null $sum_price Заказов на сумму, ₽ </br> <b>В целом по платформе.</b>
     *
     * @return self
     */
