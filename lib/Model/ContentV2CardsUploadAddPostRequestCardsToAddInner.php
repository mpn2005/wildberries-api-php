...
class ContentV2CardsUploadAddPostRequestCardsToAddInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'characteristics' => '\OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner[]',
        'sizes' => '\OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner[]'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Описание товара. Максимальное количество символов зависит от категории товара. Стандарт — 2000, минимум — 1000, максимум — 5000.<br> Подробно о правилах описания в **Правилах заполнения карточки товара** в [Справочном центре](https://seller.wildberries.ru/help-center/article/A-113#описание) на портале продавцов.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner[]|null $characteristics Характеристики товара
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner[]|null $sizes Массив с размерами. <br>  Если для размерного товара (обувь, одежда и др.) не указать этот массив, то системой в карточке он будет сгенерирован автоматически с `techSize` = \"A\" и `wbSize` = \"1\" и баркодом.
     *
     * @return self
     */
