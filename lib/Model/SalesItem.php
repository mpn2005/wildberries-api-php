...
class SalesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets for_pay
     *
     * @param float|null $for_pay К перечислению продавцку
     *
     * @return self
     */
     ...
     *
     * @param float|null $price_with_disc Цена, от которой считается вознаграждение продавца `forpay` (с учетом всех согласованных скидок)
     *
     * @return self
     */
