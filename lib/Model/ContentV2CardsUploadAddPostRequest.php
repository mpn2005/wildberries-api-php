...
class ContentV2CardsUploadAddPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id `imtID` карточки товара, к которой добавляется карточка товара
     *
     * @return self
     */
     ...
     * Sets cards_to_add
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInner[]|null $cards_to_add Структура добавляемой карточки товара
     *
     * @return self
     */
