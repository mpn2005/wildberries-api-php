<?php
/**
 * AdvV0IntervalsPostRequestIntervalsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvV0IntervalsPostRequestIntervalsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0IntervalsPostRequestIntervalsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_intervals_post_request_intervals_inner';
    ...
    */
     ...
     * Sets begin
     *
     * @param int|null $begin Время начала показов, по 24 часовой схеме (\"begin\": 15)
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param int|null $end Время окончания показов, по 24 часовой схеме (\"end\": 21)
     *
     * @return self
     */
