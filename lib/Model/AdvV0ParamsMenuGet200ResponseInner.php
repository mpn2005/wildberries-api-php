...
/**
 * AdvV0ParamsMenuGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0ParamsMenuGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_params_menu_get_200_response_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Значение для параметра `menuId`
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название меню, где размещается кампания
     *
     * @return self
     */
