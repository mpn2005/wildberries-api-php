...
class ResponseInfoAdvertType8AutoParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets menus
     *
     * @param \OpenAPI\Client\Model\ResponseInfoAdvertType8AutoParamsMenusInner[]|null $menus 
     *
     * @return self
     */
     ...
     * Sets cpm
     *
     * @param int|null $cpm Ставка (Отображается только при наличии) <span class=\"new\">new</span>
     *
     * @return self
     */
