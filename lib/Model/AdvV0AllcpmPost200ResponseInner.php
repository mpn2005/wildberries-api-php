...
/**
 * AdvV0AllcpmPost200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AllcpmPost200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_allcpm_post_200_response_inner';
    ...
    protected static $openAPITypes = [
        'param' => 'int',
        'cpm' => '\OpenAPI\Client\Model\AdvV0AllcpmPost200ResponseInnerCpmInner[]'
    ];
    ...
    */
     ...
     * Sets param
     *
     * @param int|null $param Значение параметра (param) запроса
     *
     * @return self
     */
     ...
     * Gets cpm
     *
     * @return \OpenAPI\Client\Model\AdvV0AllcpmPost200ResponseInnerCpmInner[]|null
     */
     ...
     * Sets cpm
     *
     * @param \OpenAPI\Client\Model\AdvV0AllcpmPost200ResponseInnerCpmInner[]|null $cpm Информация о ставке(-ах)
     *
     * @return self
     */
