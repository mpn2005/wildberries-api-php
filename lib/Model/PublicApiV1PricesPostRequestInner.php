...
/**
 * PublicApiV1PricesPostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiV1PricesPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_public_api_v1_prices_post_request_inner';
    ...
    */
     ...
     * Sets nm_id
     *
     * @param int|null $nm_id Номенклатура
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Цена (указывать без копеек)
     *
     * @return self
     */
