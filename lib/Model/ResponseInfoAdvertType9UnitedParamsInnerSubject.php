...
/**
 * ResponseInfoAdvertType9UnitedParamsInnerSubject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseInfoAdvertType9UnitedParamsInnerSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInfoAdvertType9_unitedParams_inner_subject';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID предметной группы, для которой создана камания
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название предметной группы
     *
     * @return self
     */
