...
/**
 * ApiV1FeedbacksProductsRatingTopGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FeedbacksProductsRatingTopGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_feedbacks_products_rating_top_get_200_response_data_inner';
    ...
    protected static $openAPITypes = [
        'product_max_rating' => '\OpenAPI\Client\Model\ProductRating',
        'product_min_rating' => '\OpenAPI\Client\Model\ProductRating'
    ];
    ...
    protected static $openAPIFormats = [
        'product_max_rating' => null,
        'product_min_rating' => null
    ];
    ...
    protected static array $openAPINullables = [
        'product_max_rating' => false,
		'product_min_rating' => false
    ];
    ...
    protected static $setters = [
        'product_max_rating' => 'setProductMaxRating',
        'product_min_rating' => 'setProductMinRating'
    ];
    ...
    protected static $getters = [
        'product_max_rating' => 'getProductMaxRating',
        'product_min_rating' => 'getProductMinRating'
    ];
    ...
    {
        $this->setIfExists('product_max_rating', $data ?? [], null);
        $this->setIfExists('product_min_rating', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets product_max_rating
     *
     * @return \OpenAPI\Client\Model\ProductRating|null
     */
    public function getProductMaxRating()
    {
        return $this->container['product_max_rating'];
    }

    /**
     * Sets product_max_rating
     *
     * @param \OpenAPI\Client\Model\ProductRating|null $product_max_rating product_max_rating
     *
     * @return self
     */
    public function setProductMaxRating($product_max_rating)
    {
        if (is_null($product_max_rating)) {
            throw new \InvalidArgumentException('non-nullable product_max_rating cannot be null');
        }
        $this->container['product_max_rating'] = $product_max_rating;

        return $this;
    }

    /**
     * Gets product_min_rating
     *
     * @return \OpenAPI\Client\Model\ProductRating|null
     */
    public function getProductMinRating()
    {
        return $this->container['product_min_rating'];
    }

    /**
     * Sets product_min_rating
     *
     * @param \OpenAPI\Client\Model\ProductRating|null $product_min_rating product_min_rating
     *
     * @return self
     */
    public function setProductMinRating($product_min_rating)
    {
        if (is_null($product_min_rating)) {
            throw new \InvalidArgumentException('non-nullable product_min_rating cannot be null');
        }
        $this->container['product_min_rating'] = $product_min_rating;
