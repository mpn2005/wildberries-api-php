...
/**
 * ContentV1CardsUpdatePostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsUpdatePostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_update_post_request_inner';
    ...
    protected static $openAPITypes = [
        ...
        'vendor_code' => 'string',
        'media_files' => 'string[]',
        'sizes' => '\OpenAPI\Client\Model\ContentV1CardsUpdatePostRequestInnerSizesInner[]',
    ...
    */
     ...
     * Gets sizes
     *
     * @return \OpenAPI\Client\Model\ContentV1CardsUpdatePostRequestInnerSizesInner[]
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\ContentV1CardsUpdatePostRequestInnerSizesInner[] $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив без параметров (`wbSize` и `techSize`), но с `chrtID` и баркодом)
     *
     * @return self
     */
