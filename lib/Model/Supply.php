...
class Supply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Идентификатор поставки
     *
     * @return self
     */
     ...
     * Sets done
     *
     * @param bool|null $done Флаг закрытия поставки
     *
     * @return self
     */
    ...
    {
        if (is_null($scan_dt)) {
            throw new \InvalidArgumentException('non-nullable scan_dt cannot be null');
        }
     ...
     * Sets is_large_cargo
     *
     * @param bool|null $is_large_cargo сКГТ-признак поставки
     *
     * @return self
     */
    public function setIsLargeCargo($is_large_cargo)
    {
        if (is_null($is_large_cargo)) {
            array_push($this->openAPINullablesSetToNull, 'is_large_cargo');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_large_cargo', $nullablesSetToNull);
            if ($index !== FALSE) {
