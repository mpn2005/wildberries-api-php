...
/**
 * PublicApiV1PricesPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiV1PricesPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_public_api_v1_prices_post_200_response';
    ...
    */
     ...
     * Sets upload_id
     *
     * @param string|null $upload_id ID загрузки
     *
     * @return self
     */
     ...
     * Sets already_exists
     *
     * @param bool|null $already_exists Загрузка с загружаемыми данными уже существует (`true` - да, `false` - нет)
     *
     * @return self
     */
