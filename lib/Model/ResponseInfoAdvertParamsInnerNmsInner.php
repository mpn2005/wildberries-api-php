...
/**
 * ResponseInfoAdvertParamsInnerNmsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseInfoAdvertParamsInnerNmsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInfoAdvert_params_inner_nms_inner';
    ...
    */
     ...
     * Sets nm
     *
     * @param int|null $nm Числовой идентификатор номенклатуры Wildberries (<code>nmId</code>)
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Состояние номенклатуры (<code>true</code> - активна или <code>false</code> - неактивна)
     *
     * @return self
     */
