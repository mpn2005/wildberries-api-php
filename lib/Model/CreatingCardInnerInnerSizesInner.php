...
/**
 * CreatingCardInnerInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatingCardInnerInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creatingCard_inner_inner_sizes_inner';
    ...
    */
     ...
     * Sets skus
     *
     * @param string[]|null $skus Массив баркодов, строковых идентификаторов размеров товара (их можно сгенерировать с помощью API, см. раздел \"Контент / Просмотр\")
     *
     * @return self
     */
