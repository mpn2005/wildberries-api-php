...
/**
 * PublicApiV1RevokeDiscountsPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiV1RevokeDiscountsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_public_api_v1_revokeDiscounts_post_200_response';
    ...
    */
     ...
     * Sets upload_id
     *
     * @param int|null $upload_id Номер запроса на сброс скидки
     *
     * @return self
     */
     ...
     * Sets already_exists
     *
     * @param bool|null $already_exists Данное поле обозначает что скидка уже была сброшена
     *
     * @return self
     */
