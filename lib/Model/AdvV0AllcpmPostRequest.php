...
/**
 * AdvV0AllcpmPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AllcpmPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_allcpm_post_request';
    ...
    */
     ...
     * Sets param
     *
     * @param int[]|null $param Массив параметров запроса, по которым будет получен список ставок активных кампаний: должен быть значением `menuId` (для кампании в каталоге), `subjectId` (для кампании в поиске и рекомендациях) или `setId` (для кампании в карточке товара).
     *
     * @return self
     */
