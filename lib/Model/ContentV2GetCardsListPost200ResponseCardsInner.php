...
class ContentV2GetCardsListPost200ResponseCardsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id ID карточки товара. <br> Артикулы WB из одной карточки товара будут иметь одинаковый imtID
     *
     * @return self
     */
     ...
     * Sets nm_uuid
     *
     * @param string|null $nm_uuid Внутренний технический ID товара
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Дата изменения
     *
     * @return self
     */
