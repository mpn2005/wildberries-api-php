...
class AdvV1BudgetDepositPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sum
     *
     * @param int|null $sum Сумма пополнения (min. 500 ₽)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type <dl> <dt>Тип источника пополнения:</dt> <dd><code>0</code> - balance</dd> <dd><code>1</code> - net</dd> <dd><code>3</code> - bonus</dd> </dl>
     *
     * @return self
     */
