...
/**
 * ApiV1FeedbacksProductsRatingNmidGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FeedbacksProductsRatingNmidGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_feedbacks_products_rating_nmid_get_200_response_data';
    ...
    */
     ...
     * Sets valuation
     *
     * @param string|null $valuation Средняя оценка товара
     *
     * @return self
     */
     ...
     *
     * @param int|null $feedbacks_count Количество отзывов на данный товар
     *
     * @return self
     */
