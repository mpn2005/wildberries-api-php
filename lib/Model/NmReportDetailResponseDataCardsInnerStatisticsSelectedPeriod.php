...
/**
 * NmReportDetailResponseDataCardsInnerStatisticsSelectedPeriod Class Doc Comment
 *
 * @category Class
 ...
 */
class NmReportDetailResponseDataCardsInnerStatisticsSelectedPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailResponse_data_cards_inner_statistics_selectedPeriod';
    ...
    */
     ...
     * Sets cancel_count
     *
     * @param int|null $cancel_count Отменили товаров, шт.
     *
     * @return self
     */
