...
/**
 * AdvV1SearchSetStrongPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1SearchSetStrongPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_search_set_strong_post_request';
    ...
    */
     ...
     * Sets strong
     *
     * @param string[]|null $strong Минус-фразы
     *
     * @return self
     */
