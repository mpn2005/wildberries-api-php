...
class ApiV3OrdersStickersPost200ResponseStickersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets part_a
     *
     * @param int|null $part_a Первая часть идентификатора этикетки (для печати подписи)
     *
     * @return self
     */
     ...
     * Sets part_b
     *
     * @param int|null $part_b Вторая часть идентификатора этикетки
     *
     * @return self
     */
     ...
     * Sets barcode
     *
     * @param string|null $barcode Закодированное значение этикетки
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string|null $file Полное представление этикетки в заданном формате. (кодировка base64)
     *
     * @return self
     */
