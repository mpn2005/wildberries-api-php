<?php
/**
 * AdvV0AdvertsCreatePostRequestInnerParamsInnerIntervalsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvV0AdvertsCreatePostRequestInnerParamsInnerIntervalsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AdvertsCreatePostRequestInnerParamsInnerIntervalsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_adverts_create_post_request_inner_params_inner_intervals_inner';
    ...
    */
     ...
     * Sets begin
     *
     * @param int|null $begin Время начала показов
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param int|null $end Время окончания показов
     *
     * @return self
     */
