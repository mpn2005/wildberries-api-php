...
/**
 * AdvV1SaveAdPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1SaveAdPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_save_ad_post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('btype', $data ?? [], null);
        $this->setIfExists('on_pause', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type <dl> <dt>Тип создаваемой кампании:</dt> <dd><code>8</code> - автоматическая кампания</dd> </dl>
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название кампании (max. 128 символов)
     *
     * @return self
     */
     ...
     * Sets subject_id
     *
     * @param int|null $subject_id ID предмета, для которого создается кампания.<br> Существующие у продавца идентификаторы можно получить методом из раздела \"Контент / Просмотр\" - \"Список НМ\", поле ответа - `objectID`.
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param int|null $sum Сумма пополнения
     *
     * @return self
     */
    ...
    {
        return $this->container['btype'];
    }

    /**
     * Sets btype
     *
     * @param int|null $btype <dl> <dt>Tип списания.</dt> <dd><code>0</code> - balance</dd> <dd><code>1</code> - net</dd> <dd><code>3</code> - bonus</dd> </dl>
     *
     * @return self
     */
    ...
    {
        if (is_null($btype)) {
            throw new \InvalidArgumentException('non-nullable btype cannot be null');
        }
        $this->container['btype'] = $btype;
    ...
    {
        return $this->container['on_pause'];
    }

    /**
     * Sets on_pause
     *
     * @param bool|null $on_pause <dl> <dt>После создания кампания <span class=\"new\">NEW</span></dt>  <dd><code>true</code> - будет на паузе</dd>  <dd><code>false</code> - будет сразу запущена</dd>  </dl>
     *
     * @return self
     */
    public function setOnPause($on_pause)
    {
        if (is_null($on_pause)) {
            throw new \InvalidArgumentException('non-nullable on_pause cannot be null');
        }
        $this->container['on_pause'] = $on_pause;
