...
/**
 * AdvV0NmactivePostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0NmactivePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_nmactive_post_request';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'active' => '\OpenAPI\Client\Model\AdvV0NmactivePostRequestActiveInner[]',
        'param' => 'int'
    ];
    ...
    */
     ...
     * Gets active
     *
     * @return \OpenAPI\Client\Model\AdvV0NmactivePostRequestActiveInner[]
     */
     ...
     * Sets active
     *
     * @param \OpenAPI\Client\Model\AdvV0NmactivePostRequestActiveInner[] $active Массив значений активности для номенклатур. <br> Максимальноe количество номенклатур в запросе `50`.
     *
     * @return self
     */
     ...
     * Sets param
     *
     * @param int $param Параметр, для которого будет внесено изменение, должен быть значением `subjectId` (для кампании в поиске и рекомендациях) или `setId` (для кампании в карточке товара).
     *
     * @return self
     */
