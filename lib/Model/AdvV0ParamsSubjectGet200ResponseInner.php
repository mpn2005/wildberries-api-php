...
/**
 * AdvV0ParamsSubjectGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0ParamsSubjectGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_params_subject_get_200_response_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Значение для параметра `subjectId`
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название предметной группы, для которой создана кампания
     *
     * @return self
     */
