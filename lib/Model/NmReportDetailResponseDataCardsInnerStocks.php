...
/**
 * NmReportDetailResponseDataCardsInnerStocks Class Doc Comment
 *
 * @category Class
 * @description Остатки
 * @package  OpenAPI\Client
 ...
 */
class NmReportDetailResponseDataCardsInnerStocks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailResponse_data_cards_inner_stocks';
    ...
    protected static $setters = [
        'stocks_mp' => 'setStocksMp',
        'stocks_wb' => 'setStocksWb'
    ];
    ...
    protected static $getters = [
        'stocks_mp' => 'getStocksMp',
        'stocks_wb' => 'getStocksWb'
    ];
    ...
    {
        $this->setIfExists('stocks_mp', $data ?? [], null);
        $this->setIfExists('stocks_wb', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getStocksMp()
    {
        return $this->container['stocks_mp'];
    }

    /**
     * Sets stocks_mp
     *
     * @param int|null $stocks_mp Остатки МП, шт. (Общее количество остатков на складе продавца)
     *
     * @return self
     */
    public function setStocksMp($stocks_mp)
    {
        if (is_null($stocks_mp)) {
            throw new \InvalidArgumentException('non-nullable stocks_mp cannot be null');
        }
        $this->container['stocks_mp'] = $stocks_mp;
     ...
     * @return int|null
     */
    public function getStocksWb()
    {
        return $this->container['stocks_wb'];
    }

    /**
     * Sets stocks_wb
     *
     * @param int|null $stocks_wb Остатки на складах Wildberries (Общее количество остатков на складах Wildberries)
     *
     * @return self
     */
    public function setStocksWb($stocks_wb)
    {
        if (is_null($stocks_wb)) {
            throw new \InvalidArgumentException('non-nullable stocks_wb cannot be null');
        }
        $this->container['stocks_wb'] = $stocks_wb;
