...
/**
 * ProductRating Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'productRating';
    ...
    protected static $setters = [
        'nm_id' => 'setNmId',
        'imt_id' => 'setImtId',
        'valuations_sum' => 'setValuationsSum',
        'feedbacks_count' => 'setFeedbacksCount',
    ...
    protected static $getters = [
        'nm_id' => 'getNmId',
        'imt_id' => 'getImtId',
        'valuations_sum' => 'getValuationsSum',
        'feedbacks_count' => 'getFeedbacksCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('valuations_sum', $data ?? [], null);
        $this->setIfExists('feedbacks_count', $data ?? [], null);
    ...
    */
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id Идентификатор карточки товара
     *
     * @return self
     */
    ...
    {
        return $this->container['valuations_sum'];
    }

    /**
     * Sets valuations_sum
     *
     * @param int|null $valuations_sum Сумма оценок
     *
     * @return self
     */
    public function setValuationsSum($valuations_sum)
    {
        if (is_null($valuations_sum)) {
            throw new \InvalidArgumentException('non-nullable valuations_sum cannot be null');
        }
        $this->container['valuations_sum'] = $valuations_sum;

        return $this;
    }

    /**
     * Gets feedbacks_count
     *
     * @return int|null
     */
    public function getFeedbacksCount()
    {
        return $this->container['feedbacks_count'];
    }

    /**
     * Sets feedbacks_count
     *
     * @param int|null $feedbacks_count Количество отзывов
     *
     * @return self
     */
    public function setFeedbacksCount($feedbacks_count)
    {
        if (is_null($feedbacks_count)) {
            throw new \InvalidArgumentException('non-nullable feedbacks_count cannot be null');
        }
        $this->container['feedbacks_count'] = $feedbacks_count;
     ...
     * Sets valuation
     *
     * @param float|null $valuation Средняя оценка
     *
     * @return self
     */
