...
/**
 * NmReportGroupedResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NmReportGroupedResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedResponse_data';
    ...
    protected static $openAPITypes = [
        'page' => 'int',
        'is_next_page' => 'bool',
        'groups' => '\OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_next_page', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsNextPage()
    {
        return $this->container['is_next_page'];
    }

    /**
     * Sets is_next_page
     *
     * @param bool|null $is_next_page Есть ли следующая страница (false - нет, true - есть)
     *
     * @return self
     */
    public function setIsNextPage($is_next_page)
    {
        if (is_null($is_next_page)) {
            throw new \InvalidArgumentException('non-nullable is_next_page cannot be null');
        }
        $this->container['is_next_page'] = $is_next_page;
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInner[]|null
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInner[]|null $groups groups
     *
     * @return self
     */
