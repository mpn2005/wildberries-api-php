<?php
/**
 * AdvV0AdvertsCreatePostRequestInnerParamsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvV0AdvertsCreatePostRequestInnerParamsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AdvertsCreatePostRequestInnerParamsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_adverts_create_post_request_inner_params_inner';
    ...
    */
     ...
     * Sets intervals
     *
     * @param \OpenAPI\Client\Model\AdvV0AdvertsCreatePostRequestInnerParamsInnerIntervalsInner[]|null $intervals Интервалы часов показа кампании (max. 24)
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price Текущая ставка. Для кампаний в каталоге, в карточке товара и в поиске `price` >= 50. <br> Для кампаний в рекомендациях `price` >= 250.
     *
     * @return self
     */
