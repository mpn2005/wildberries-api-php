...
/**
 * AdvV0CpmGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0CpmGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_cpm_get_200_response_inner';
    ...
    {
        $this->setIfExists('cmp', $data ?? [], null);
    ...
    */
     ...
     * Sets cmp
     *
     * @param int|null $cmp Размер ставки
     *
     * @return self
     */
    ...
    {
        if (is_null($cmp)) {
            throw new \InvalidArgumentException('non-nullable cmp cannot be null');
        }
     ...
     * Sets count
     *
     * @param int|null $count Количество ставок
     *
     * @return self
     */
