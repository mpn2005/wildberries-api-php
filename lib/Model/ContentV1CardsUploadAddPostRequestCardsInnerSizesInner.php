...
/**
 * ContentV1CardsUploadAddPostRequestCardsInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsUploadAddPostRequestCardsInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_upload_add_post_request_cards_inner_sizes_inner';
    ...
    */
     ...
     * Sets price
     *
     * @param int|null $price Цена (указывается в рублях)
     *
     * @return self
     */
