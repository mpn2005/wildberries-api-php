...
/**
 * AdvV0ParamsSetGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0ParamsSetGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_params_set_get_200_response_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Значение для параметра `setId`
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Сочетание предмета и пола
     *
     * @return self
     */
