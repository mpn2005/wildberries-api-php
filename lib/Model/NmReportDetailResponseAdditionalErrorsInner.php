<?php
/**
 * NmReportDetailResponseAdditionalErrorsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NmReportDetailResponseAdditionalErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NmReportDetailResponseAdditionalErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailResponse_additionalErrors_inner';
    ...
    */
     ...
     * Sets field
     *
     * @param string|null $field Структура, где допущена ошибка
     *
     * @return self
     */
