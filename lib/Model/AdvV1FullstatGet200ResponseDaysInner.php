...
/**
 * AdvV1FullstatGet200ResponseDaysInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1FullstatGet200ResponseDaysInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_fullstat_get_200_response_days_inner';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'apps' => '\OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInner[]',
        'views' => 'int',
        'clicks' => 'int',
        'frq' => 'int',
        'unique_users' => 'int',
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Дата генерации блока данных. В блоке отображаются статистические данные за эту дату.
     *
     * @return self
     */
     ...
     * Gets apps
     *
     * @return \OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInner[]|null
     */
     ...
     * Sets apps
     *
     * @param \OpenAPI\Client\Model\AdvV1FullstatGet200ResponseDaysInnerAppsInner[]|null $apps Блок информации о платформе
     *
     * @return self
     */
     ...
     * Sets views
     *
     * @param int|null $views Количество просмотров<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int|null $clicks Количество кликов.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets frq
     *
     * @param int|null $frq Частота (отношение количества просмотров к количеству уникальных пользователей)<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets unique_users
     *
     * @param int|null $unique_users Количество уникальных пользователей просмотревших товар.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets ctr
     *
     * @param float|null $ctr Показатель кликабельности.<br> Отношение числа кликов к количеству показов. Выражается в процентах.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc Средняя стоимость клика, ₽.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float|null $sum Затраты, ₽.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets atbs
     *
     * @param int|null $atbs Количество добавлений товаров в корзину.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets orders
     *
     * @param int|null $orders Количество заказов товара.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets cr
     *
     * @param int|null $cr CR(conversion rate) — это отношение количества заказов к общему количеству посещений кампании.<br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets shks
     *
     * @param int|null $shks Заказано товаров, шт <br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets sum_price
     *
     * @param int|null $sum_price Заказов на сумму, ₽</br> <b>За день, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
