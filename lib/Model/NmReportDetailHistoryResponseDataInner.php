...
/**
 * NmReportDetailHistoryResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NmReportDetailHistoryResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailHistoryResponse_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'imt_name' => 'string',
        'vendor_code' => 'string',
        'history' => '\OpenAPI\Client\Model\NmReportDetailHistoryResponseDataInnerHistoryInner[]'
    ];
    ...
    */
     ...
     * Sets imt_name
     *
     * @param string|null $imt_name Наименование КТ
     *
     * @return self
     */
    ...
    {
        if (is_null($imt_name)) {
            throw new \InvalidArgumentException('non-nullable imt_name cannot be null');
        }
     ...
     * Gets history
     *
     * @return \OpenAPI\Client\Model\NmReportDetailHistoryResponseDataInnerHistoryInner[]|null
     */
     ...
     * Sets history
     *
     * @param \OpenAPI\Client\Model\NmReportDetailHistoryResponseDataInnerHistoryInner[]|null $history history
     *
     * @return self
     */
