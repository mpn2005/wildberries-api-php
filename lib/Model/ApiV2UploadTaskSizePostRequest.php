...
class ApiV2UploadTaskSizePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SizeGoodReq[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SizeGoodReq[]|null $data Размеры и цены для них. Максимум 1 000 размеров. <br><br> Для товаров с поразмерной установкой цен карантин не применяется
     *
     * @return self
     */
