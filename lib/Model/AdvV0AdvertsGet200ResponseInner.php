...
/**
 * AdvV0AdvertsGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AdvertsGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_adverts_get_200_response_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type <dl> <dt>Тип кампании:</dt> <dd><code>4</code> - кампания в каталоге</dd> <dd><code>5</code> - кампания в карточке товара</dd> <dd><code>6</code> - кампания в поиске</dd> <dd><code>7</code> - кампания в рекомендациях на главной странице</dd> <dd><code>8</code> - автоматическая кампания </dd> <dd><code>9</code> - поиск + каталог </dd> </dl>
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int|null $status <dl> <dt>Статус кампании:</dt> <dd><code>4</code> - готова к запуску </dd> <dd><code>7</code> - кампания завершена</dd> <dd><code>8</code> - отказался</dd> <dd><code>9</code> - идут показы</dd> <dd><code>11</code> - кампания на паузе</dd> </dl>
     *
     * @return self
     */
     ...
     * Sets daily_budget
     *
     * @param string|null $daily_budget Сумма дневного бюджета
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param string|null $start_time Время последнего запуска кампании
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param string|null $end_time Время завершения кампании (state 7)
     *
     * @return self
     */
