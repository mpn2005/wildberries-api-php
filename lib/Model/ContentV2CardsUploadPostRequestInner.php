...
class ContentV2CardsUploadPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets variants
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadPostRequestInnerVariantsInner[] $variants Массив вариантов товара. В каждой объединённой карточке товара может быть не более 30 карточек товаров
     *
     * @return self
     */
