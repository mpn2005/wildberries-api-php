...
/**
 * ResponseInfoAdvertType9UnitedParamsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseInfoAdvertType9UnitedParamsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInfoAdvertType9_unitedParams_inner';
    ...
    protected static $openAPITypes = [
        'subject' => '\OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerSubject',
        'menus' => '\OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerMenusInner[]',
        'nms' => 'int[]',
        'search_cpm' => 'int',
        'catalog_cpm' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'menus' => 'setMenus',
        'nms' => 'setNms',
        'search_cpm' => 'setSearchCpm',
        'catalog_cpm' => 'setCatalogCpm'
    ];
    ...
    protected static $getters = [
        ...
        'menus' => 'getMenus',
        'nms' => 'getNms',
        'search_cpm' => 'getSearchCpm',
        'catalog_cpm' => 'getCatalogCpm'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('search_cpm', $data ?? [], null);
        $this->setIfExists('catalog_cpm', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets subject
     *
     * @return \OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerSubject|null
     */
     ...
     * Sets subject
     *
     * @param \OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerSubject|null $subject subject
     *
     * @return self
     */
     ...
     * Gets menus
     *
     * @return \OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerMenusInner[]|null
     */
     ...
     * Sets menus
     *
     * @param \OpenAPI\Client\Model\ResponseInfoAdvertType9UnitedParamsInnerMenusInner[]|null $menus menus
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getSearchCpm()
    {
        return $this->container['search_cpm'];
    }

    /**
     * Sets search_cpm
     *
     * @param int|null $search_cpm Ставка в Поиске. <span class=\"new\">new</span>
     *
     * @return self
     */
    public function setSearchCpm($search_cpm)
    {
        if (is_null($search_cpm)) {
            throw new \InvalidArgumentException('non-nullable search_cpm cannot be null');
        }
        $this->container['search_cpm'] = $search_cpm;
     ...
     * @return int|null
     */
    public function getCatalogCpm()
    {
        return $this->container['catalog_cpm'];
    }

    /**
     * Sets catalog_cpm
     *
     * @param int|null $catalog_cpm Ставка в Каталоге, при наличии. <span class=\"new\">new</span>
     *
     * @return self
     */
    public function setCatalogCpm($catalog_cpm)
    {
        if (is_null($catalog_cpm)) {
            throw new \InvalidArgumentException('non-nullable catalog_cpm cannot be null');
        }
        $this->container['catalog_cpm'] = $catalog_cpm;
