<?php
/**
 * ApiV1QuestionsPatchRequestOneOf2
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ApiV1QuestionsPatchRequestOneOf2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1QuestionsPatchRequestOneOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_questions_patch_request_oneOf_2';
    ...
    */
     ...
     * Sets state
     *
     * @param string $state Статус вопроса (wbRu) - ответ предоставлен, вопрос отображается на сайте покупателей.
     *
     * @return self
     */
