...
/**
 * NmReportGroupedHistoryResponseDataInnerObject Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  OpenAPI\Client
 ...
 */
class NmReportGroupedHistoryResponseDataInnerObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedHistoryResponse_data_inner_object';
