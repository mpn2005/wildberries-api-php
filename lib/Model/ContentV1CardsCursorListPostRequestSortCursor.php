...
/**
 * ContentV1CardsCursorListPostRequestSortCursor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsCursorListPostRequestSortCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_cursor_list_post_request_sort_cursor';
    ...
    */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Время обновления последней КТ из предыдущего ответа на запрос списка КТ.
     *
     * @return self
     */
     ...
     * Sets nm_id
     *
     * @param int|null $nm_id Артикул WB последней КТ из предыдущего ответа на запрос списка КТ.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Кол-во запрашиваемых КТ.
     *
     * @return self
     */
