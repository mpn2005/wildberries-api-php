<?php
/**
 * ResponseBodyContentError400AdditionalErrors
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ResponseBodyContentError400AdditionalErrors Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseBodyContentError400AdditionalErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'responseBodyContentError400_additionalErrors';
    ...
    protected static $setters = [
        'move_nms_to_trash' => 'setMoveNmsToTrash'
    ];
    ...
    protected static $getters = [
        'move_nms_to_trash' => 'getMoveNmsToTrash'
    ];
    ...
    {
        $this->setIfExists('move_nms_to_trash', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets move_nms_to_trash
     *
     * @return string|null
     */
    public function getMoveNmsToTrash()
    {
        return $this->container['move_nms_to_trash'];
    }

    /**
     * Sets move_nms_to_trash
     *
     * @param string|null $move_nms_to_trash move_nms_to_trash
     *
     * @return self
     */
    public function setMoveNmsToTrash($move_nms_to_trash)
    {
        if (is_null($move_nms_to_trash)) {
            throw new \InvalidArgumentException('non-nullable move_nms_to_trash cannot be null');
        }
        $this->container['move_nms_to_trash'] = $move_nms_to_trash;
