...
/**
 * ContentV1CardsCursorListPostRequestSortSort Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsCursorListPostRequestSortSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_cursor_list_post_request_sort_sort';
    ...
    */
     ...
     * Sets sort_column
     *
     * @param string|null $sort_column Поле, по которому будет сортироваться список КТ (пока поддерживается только updateAt).
     *
     * @return self
     */
