...
/**
 * NmReportDetailResponseDataCardsInnerObject Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  OpenAPI\Client
 ...
 */
class NmReportDetailResponseDataCardsInnerObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailResponse_data_cards_inner_object';
