...
class ContentV2CardsUpdatePostRequestInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets chrt_id
     *
     * @param int|null $chrt_id Числовой ID размера для данного артикула WB Обязателен к заполнению для существующих размеров. Для добавляемых размеров не указывается.
     *
     * @return self
     */
     ...
     * Sets tech_size
     *
     * @param string|null $tech_size Размер товара (XL, S, 45 и др.)
     *
     * @return self
     */
