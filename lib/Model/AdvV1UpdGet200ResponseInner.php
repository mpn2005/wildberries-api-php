...
class AdvV1UpdGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets advert_status
     *
     * @param int|null $advert_status <dl>   <dt>Статус кампании:</dt>   <dd><code>4</code> - готова к запуску </dd>   <dd><code>7</code> - завершена</dd>   <dd><code>8</code> - отказался</dd>   <dd><code>9</code> - активна</dd>   <dd><code>11</code> - приостановлена</dd> </dl>
     *
     * @return self
     */
