...
class AdvV1UpdGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets upd_num
     *
     * @param int|null $upd_num Номер выставленного документа (при наличии)
     *
     * @return self
     */
    ...
    {
        if (is_null($upd_time)) {
            throw new \InvalidArgumentException('non-nullable upd_time cannot be null');
        }
     ...
     * Sets payment_type
     *
     * @param string|null $payment_type <dl> <dt>Источник списания:</dt> <dd>Баланс</dd> <dd>Бонусы</dd> <dd>Счет</dd> </dl>
     *
     * @return self
     */
     ...
     * Sets advert_status
     *
     * @param int|null $advert_status <dl>   <dt>Статус кампании:</dt>   <dd><code>4</code> - готова к запуску <span class=\"new\">new</span></dd>   <dd><code>7</code> - завершена</dd>   <dd><code>8</code> - отказался</dd>   <dd><code>9</code> - активна</dd>   <dd><code>11</code> - приостановлена</dd> </dl>
     *
     * @return self
     */
