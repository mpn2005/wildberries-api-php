    ...
    */
    ...
    public function setUploadDate($upload_date)
    {
        ...
        if ((!preg_match("/YYYY-MM-DDTHH:MM:SSZ/", ObjectSerializer::toString($upload_date)))) {
            throw new \InvalidArgumentException("invalid value for \$upload_date when calling SupplierTaskMetadata., must conform to the pattern /YYYY-MM-DDTHH:MM:SSZ/.");
        }
    ...
    public function setActivationDate($activation_date)
    {
        ...
        if ((!preg_match("/YYYY-MM-DDTHH:MM:SSZ/", ObjectSerializer::toString($activation_date)))) {
            throw new \InvalidArgumentException("invalid value for \$activation_date when calling SupplierTaskMetadata., must conform to the pattern /YYYY-MM-DDTHH:MM:SSZ/.");
        }
