 ...
 *
 * @category Class
 * @description Габариты и вес товара &#x60;c упаковкой&#x60;. Указывать в &#x60;сантиметрах&#x60; и &#x60;килограммах&#x60; для любого товара.  &lt;br&gt;  Если не указать структуру dimensions в запросе, то она сгенерируется системой автоматически с нулевыми значениями длины, ширины, высоты, веса
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
