<?php
/**
 * AdvV0NmactivePostRequestActiveInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvV0NmactivePostRequestActiveInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0NmactivePostRequestActiveInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_nmactive_post_request_active_inner';
    ...
    */
     ...
     * Sets nm
     *
     * @param int|null $nm Артикул WB (`nmId`)
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Новое состояние (`true` - сделать номенклатуру активной или `false` - сделать номенклатуру неактивной)
     *
     * @return self
     */
