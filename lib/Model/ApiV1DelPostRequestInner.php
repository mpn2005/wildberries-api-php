...
/**
 * ApiV1DelPostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DelPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_del_post_request_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recom'] === null) {
            $invalidProperties[] = "'recom' can't be null";
        }
     ...
     * Sets nm
     *
     * @param int $nm Идентификатор товара (`nmId`), у которого необходимо удалить рекомендацию
     *
     * @return self
     */
     ...
     * Sets recom
     *
     * @param int[] $recom Список идентификаторов товаров (`nmId`), которые необходимо удалить из рекомендуемых
     *
     * @return self
     */
