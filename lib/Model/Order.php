...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets supply_id
     *
     * @param string|null $supply_id Идентификатор поставки. Возвращается, если заказ закреплён за поставкой
     *
     * @return self
     */
     ...
     *
     * @param int|null $converted_price Цена в валюте продажи с учетом всех скидок, сконвертированная по курсу на момент продажи в российские копейки. Предоставляется в информационных целях.
     *
     * @return self
     */
     ...
     * Sets delivery_type
     *
     * @param string|null $delivery_type Тип доставки: fbs - доставка на склад Wildberries, dbs - доставка силами продавца
     *
     * @return self
     */
