...
/**
 * NmReportDetailHistoryResponseDataInnerHistoryInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NmReportDetailHistoryResponseDataInnerHistoryInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportDetailHistoryResponse_data_inner_history_inner';
    ...
    */
     ...
     *
     * @param float|null $add_to_cart_conversion Конверсия в корзину, % (Какой процент посетителей, открывших карточку товара, добавили товар в корзину)
     *
     * @return self
     */
