...
/**
 * CreatingCardInnerInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatingCardInnerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creatingCard_inner_inner';
    ...
    protected static $openAPITypes = [
        ...
        'vendor_code' => 'string',
        'sizes' => '\OpenAPI\Client\Model\CreatingCardInnerInnerSizesInner[]'
    ];
    ...
    */
     ...
     * Gets sizes
     *
     * @return \OpenAPI\Client\Model\CreatingCardInnerInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\CreatingCardInnerInnerSizesInner[]|null $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив без параметров (`wbSize` и `techSize`), но с ценой и баркодом)
     *
     * @return self
     */
