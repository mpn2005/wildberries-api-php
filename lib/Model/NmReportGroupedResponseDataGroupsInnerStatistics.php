...
/**
 * NmReportGroupedResponseDataGroupsInnerStatistics Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NmReportGroupedResponseDataGroupsInnerStatistics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedResponse_data_groups_inner_statistics';
    ...
    protected static $openAPITypes = [
        'selected_period' => '\OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsSelectedPeriod',
        'previous_period' => '\OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriod',
        'period_comparison' => '\OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparison'
    ];
    ...
    protected static $setters = [
        ...
        'previous_period' => 'setPreviousPeriod',
        'period_comparison' => 'setPeriodComparison'
    ];
    ...
    protected static $getters = [
        ...
        'previous_period' => 'getPreviousPeriod',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('previous_period', $data ?? [], null);
        $this->setIfExists('period_comparison', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsSelectedPeriod|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsSelectedPeriod|null $selected_period selected_period
     *
     * @return self
     */
    ...
    /**
     * Gets previous_period
     *
     * @return \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriod|null
     */
    public function getPreviousPeriod()
    {
        return $this->container['previous_period'];
    }

    /**
     * Sets previous_period
     *
     * @param \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriod|null $previous_period previous_period
     *
     * @return self
     */
    public function setPreviousPeriod($previous_period)
    {
        if (is_null($previous_period)) {
            throw new \InvalidArgumentException('non-nullable previous_period cannot be null');
        }
        $this->container['previous_period'] = $previous_period;

        return $this;
    }

    /**
     * Gets period_comparison
     *
     * @return \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparison|null
     */
    public function getPeriodComparison()
    {
        return $this->container['period_comparison'];
    }

    /**
     * Sets period_comparison
     *
     * @param \OpenAPI\Client\Model\NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparison|null $period_comparison period_comparison
     *
     * @return self
     */
    public function setPeriodComparison($period_comparison)
    {
        if (is_null($period_comparison)) {
            throw new \InvalidArgumentException('non-nullable period_comparison cannot be null');
        }
        $this->container['period_comparison'] = $period_comparison;
