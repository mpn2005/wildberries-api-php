...
class AdvV1FullstatGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets shks
     *
     * @param int|null $shks Заказано товаров, шт  <span class=\"new\">new</span> <br>  <b>За все дни, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
     ...
     * Sets sum_price
     *
     * @param int|null $sum_price Заказов на сумму, ₽  <span class=\"new\">new</span> </br> <b>За все дни, по всем артикулам WB и платформам.</b>
     *
     * @return self
     */
