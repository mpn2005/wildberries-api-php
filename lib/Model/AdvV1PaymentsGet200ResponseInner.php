...
class AdvV1PaymentsGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Идентификатор платежа
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type <dl> <dt>Тип источника списания:</dt> <dd><code>0</code> - balance</dd> <dd><code>1</code> - net</dd> <dd><code>3</code> - картой</dd> </dl>
     *
     * @return self
     */
     ...
     * Sets status_id
     *
     * @param int|null $status_id <dl> <dt>Статус:</dt> <dd><code>0</code> - ошибка</dd> <dd><code>1</code> - обработано</dd> </dl>
     *
     * @return self
     */
     ...
     * Sets card_status
     *
     * @param string|null $card_status <dl> <dt>Статус операции(при оплате картой):</dt> <dd><b>success</b> - успех</dd> <dd><b>fail</b> - неуспех</dd> <dd><b>pending</b> - в ожидании ответа</dd> <dd><b>unknown</b> - неизвестно</dd> </dl>
     *
     * @return self
     */
