...
/**
 * ApiV1TemplatesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1TemplatesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_templates_post_request';
    ...
    */
     ...
     * Sets template_type
     *
     * @param int $template_type Тип шаблона <br> `1` - шаблон для отзывов <br> `2` - шаблон для вопросов
     *
     * @return self
     */
