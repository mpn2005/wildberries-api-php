...
/**
 * Response200DataTemplatesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Response200DataTemplatesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response200_data_templates_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Идентификатор шаблона
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название шаблона
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Текст шаблона
     *
     * @return self
     */
