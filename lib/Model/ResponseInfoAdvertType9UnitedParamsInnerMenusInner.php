...
/**
 * ResponseInfoAdvertType9UnitedParamsInnerMenusInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseInfoAdvertType9UnitedParamsInnerMenusInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInfoAdvertType9_unitedParams_inner_menus_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID меню, где размещается кампания
     *
     * @return self
     */
