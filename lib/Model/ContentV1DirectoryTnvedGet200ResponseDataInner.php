...
/**
 * ContentV1DirectoryTnvedGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1DirectoryTnvedGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_directory_tnved_get_200_response_data_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tnved_name', $data ?? [], null);
    ...
    */
     ...
     * Sets subject_name
     *
     * @param string|null $subject_name Наименование категории
     *
     * @return self
     */
     ...
     * Sets tnved_name
     *
     * @param string|null $tnved_name Код ТНВЭД
     *
     * @return self
     */
    public function setTnvedName($tnved_name)
    {
        if (is_null($tnved_name)) {
            throw new \InvalidArgumentException('non-nullable tnved_name cannot be null');
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание кода ТНВЭД
     *
     * @return self
     */
     ...
     * Sets is_kiz
     *
     * @param bool|null $is_kiz КИЗовый ТНВЭД
     *
     * @return self
     */
