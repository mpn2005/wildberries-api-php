...
/**
 * AdvV1AutoActivePostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1AutoActivePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_auto_active_post_request';
    ...
    */
     ...
     * Sets recom
     *
     * @param bool|null $recom Рекомендации на главной (`false` - отключены, `true` - включены)
     *
     * @return self
     */
     ...
     * Sets booster
     *
     * @param bool|null $booster Поиск/Каталог (`false` - отключены, `true` - включены)
     *
     * @return self
     */
     ...
     * Sets carousel
     *
     * @param bool|null $carousel Карточка товара (`false` - отключены, `true` - включены)
     *
     * @return self
     */
