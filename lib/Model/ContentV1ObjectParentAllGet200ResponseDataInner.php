...
/**
 * ContentV1ObjectParentAllGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1ObjectParentAllGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_object_parent_all_get_200_response_data_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Идентификатор родительской категории
     *
     * @return self
     */
