...
/**
 * ContentV1CardsUpdatePostRequestInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsUpdatePostRequestInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_update_post_request_inner_sizes_inner';
    ...
    */
     ...
     * Sets chrt_id
     *
     * @param int $chrt_id Числовой идентификатор размера для данной номенклатуры Wildberries<br> Обязателен к заполнению для существующих размеров.<br> Для добавляемых размеров не указывается.
     *
     * @return self
     */
     ...
     * Sets skus
     *
     * @param string[] $skus Массив баркодов, строковых идентификаторов размеров товара (их можно сгенерировать с помощью API, см. раздел \"Контент / Просмотр\")
     *
     * @return self
     */
