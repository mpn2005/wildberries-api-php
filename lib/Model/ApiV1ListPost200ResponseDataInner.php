...
/**
 * ApiV1ListPost200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1ListPost200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_list_post_200_response_data_inner';
    ...
    */
     ...
     * Sets nm
     *
     * @param int|null $nm Артикул WB, по которому запрошены рекомендации.
     *
     * @return self
     */
     ...
     * Sets list
     *
     * @param int[]|null $list Список рекомендаций
     *
     * @return self
     */
