...
/**
 * ApiV1InsPostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1InsPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_ins_post_request_inner';
    ...
    */
     ...
     * Sets nm
     *
     * @param int $nm Идентификатор товара (`nmId`), к которому добавляется рекомендация
     *
     * @return self
     */
     ...
     * Sets recom
     *
     * @param int[] $recom Список идентификаторов товаров (`nmId`), которые необходимо добавить в рекомендуемые
     *
     * @return self
     */
