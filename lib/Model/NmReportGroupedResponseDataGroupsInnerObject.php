<?php
/**
 * NmReportGroupedResponseDataGroupsInnerObject
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NmReportGroupedResponseDataGroupsInnerObject Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  OpenAPI\Client
 ...
 */
class NmReportGroupedResponseDataGroupsInnerObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedResponse_data_groups_inner_object';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Идентификатор предмета
     *
     * @return self
     */
