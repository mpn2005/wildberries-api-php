...
/**
 * ResponseFeadbackInnerAnswer Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseFeadbackInnerAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'responseFeadback_inner_answer';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state <dt>Статус:</dt> <dd>`none` - новый</dd> <dd>`wbRu` - отображается на сайте</dd> <dd>`reviewRequired` - ответ проходит проверку</dd> <dd>`rejected` - ответ отклонён</dd>
     *
     * @return self
     */
