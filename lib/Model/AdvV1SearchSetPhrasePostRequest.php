...
/**
 * AdvV1SearchSetPhrasePostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1SearchSetPhrasePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_search_set_phrase_post_request';
    ...
    */
     ...
     * Sets phrase
     *
     * @param string[]|null $phrase Минус-фразы
     *
     * @return self
     */
