...
class ContentV2GetCardsListPost200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Дата с которой надо запрашивать следующий список карточек товаров
     *
     * @return self
     */
     ...
     * Sets nm_id
     *
     * @param int|null $nm_id Номер Артикула WB с которой надо запрашивать следующий список карточек товаров
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Кол-во возвращенных карточек товаров
     *
     * @return self
     */
