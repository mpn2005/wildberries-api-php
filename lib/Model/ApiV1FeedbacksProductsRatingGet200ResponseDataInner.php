<?php
/**
 * ApiV1FeedbacksProductsRatingGet200ResponseDataInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ApiV1FeedbacksProductsRatingGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FeedbacksProductsRatingGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_feedbacks_products_rating_get_200_response_data_inner';
    ...
    */
     ...
     * Sets valuation
     *
     * @param string|null $valuation Средняя оценка товаров
     *
     * @return self
     */
     ...
     *
     * @param int|null $feedbacks_count Количество отзывов по запрашиваемой категории
     *
     * @return self
     */
