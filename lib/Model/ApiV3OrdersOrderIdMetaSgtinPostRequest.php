<?php
/**
 * ApiV3OrdersOrderIdMetaSgtinPostRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ApiV3OrdersOrderIdMetaSgtinPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersOrderIdMetaSgtinPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v3_orders__orderId__meta_sgtin_post_request';
    ...
    protected static $openAPITypes = [
        'sgtin' => '\OpenAPI\Client\Model\ApiV3OrdersOrderIdMetaSgtinPostRequestSgtinInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sgtin']) && (count($this->container['sgtin']) > 24)) {
            $invalidProperties[] = "invalid value for 'sgtin', number of items must be less than or equal to 24.";
        }

        if (!is_null($this->container['sgtin']) && (count($this->container['sgtin']) < 1)) {
            $invalidProperties[] = "invalid value for 'sgtin', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets sgtin
     *
     * @return \OpenAPI\Client\Model\ApiV3OrdersOrderIdMetaSgtinPostRequestSgtinInner[]|null
     */
     ...
     * Sets sgtin
     *
     * @param \OpenAPI\Client\Model\ApiV3OrdersOrderIdMetaSgtinPostRequestSgtinInner[]|null $sgtin Массив КиЗов.
     *
     * @return self
     */
    public function setSgtin($sgtin)
    {
        ...
        if ((count($sgtin) > 24)) {
            throw new \InvalidArgumentException('invalid value for $sgtin when calling ApiV3OrdersOrderIdMetaSgtinPostRequest., number of items must be less than or equal to 24.');
        }
        if ((count($sgtin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sgtin when calling ApiV3OrdersOrderIdMetaSgtinPostRequest., number of items must be greater than or equal to 1.');
        }
