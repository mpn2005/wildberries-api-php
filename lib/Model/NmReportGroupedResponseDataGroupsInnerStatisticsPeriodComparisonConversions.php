...
/**
 * NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparisonConversions Class Doc Comment
 *
 * @category Class
 ...
 */
class NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparisonConversions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NmReportGroupedResponse_data_groups_inner_statistics_periodComparison_conversions';
    ...
    protected static $openAPIFormats = [
        'add_to_cart_percent' => 'int32',
        'cart_to_order_percent' => 'int32',
        'buyouts_percent' => 'int32'
    ];
    ...
    */
     ...
     *
     * @param int|null $cart_to_order_percent Конверсия в заказ, % (Какой процент поситителей, добавивших товар в корзину, сделали заказ)
     *
     * @return self
     */
     ...
     *
     * @param int|null $buyouts_percent Процент выкупа, % ( Какой процент посетителей, заказвших товар, его выкупили. Без учета товаров, которые еще доставляются покупателю.)
     *
     * @return self
     */
