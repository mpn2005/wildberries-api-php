...
class ContentV2CardsUpdatePostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUpdatePostRequestInnerCharacteristicsInner[]|null $characteristics Характеристики товара
     *
     * @return self
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUpdatePostRequestInnerSizesInner[] $sizes Массив размеров артикула. <br> Для безразмерного товара все равно нужно передавать данный массив без параметров (wbSize и techSize), но с баркодом.
     *
     * @return self
     */
