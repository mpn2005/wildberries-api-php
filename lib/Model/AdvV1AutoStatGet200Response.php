...
/**
 * AdvV1AutoStatGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1AutoStatGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_auto_stat_get_200_response';
    ...
    */
     ...
     * Sets clicks
     *
     * @param float|null $clicks Количество кликов
     *
     * @return self
     */
     ...
     * Sets ctr
     *
     * @param float|null $ctr CTR (Click-Through Rate) — показатель кликабельности. <br> Отношение числа кликов к количеству показов. Выражается в процентах.
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc CPC(от англ. cost per click — цена за клик) — это цена клика по продвигаемому товару.
     *
     * @return self
     */
