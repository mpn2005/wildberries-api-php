...
/**
 * AdvV0IntervalsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0IntervalsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_intervals_post_request';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'intervals' => '\OpenAPI\Client\Model\AdvV0IntervalsPostRequestIntervalsInner[]',
        'param' => 'int'
    ];
    ...
    */
     ...
     * Gets intervals
     *
     * @return \OpenAPI\Client\Model\AdvV0IntervalsPostRequestIntervalsInner[]
     */
     ...
     * Sets intervals
     *
     * @param \OpenAPI\Client\Model\AdvV0IntervalsPostRequestIntervalsInner[] $intervals Массив новых значений для интервалов. <br> Максимальное количество интервалов `24`.
     *
     * @return self
     */
     ...
     * Sets param
     *
     * @param int $param Параметр, для которого будет внесено изменение. Должен быть значением `subjectId` (для кампании в поиске и рекомендациях), `setId` (для кампании в карточке товара) или `menuId` (для кампании в каталоге)
     *
     * @return self
     */
