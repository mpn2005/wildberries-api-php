...
/**
 * ApiV1TemplatesPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1TemplatesPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_templates_patch_request';
    ...
    */
     ...
     * Sets template_id
     *
     * @param int $template_id Идентификатор шаблона
     *
     * @return self
     */
