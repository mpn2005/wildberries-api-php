...
/**
 * ApiV1TemplatesDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1TemplatesDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_templates_delete_request';
    ...
    */
     ...
     * Sets template_id
     *
     * @param int $template_id Идентификатор шаблона (max. 1)
     *
     * @return self
     */
