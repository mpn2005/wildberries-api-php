...
class ApiV1NewFeedbacksQuestionsGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $has_new_questions Есть ли непросмотренные вопросы (`true` есть, `false` нет)
     *
     * @return self
     */
     ...
     *
     * @param bool|null $has_new_feedbacks Есть ли непросмотренные отзывы (`true` есть, `false` нет)
     *
     * @return self
     */
